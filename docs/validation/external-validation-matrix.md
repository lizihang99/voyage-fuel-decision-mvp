...
| M07-F09 | M07 约束搜索 | 约束边界状态和固定报告点 | `test_constraints=INTERNAL_ONLY`；`test_calculator=INTERNAL_ONLY`；本轮C验证：C-CASE-01、C-CASE-04=DIFFERENCE；C-CASE-02～03、C-CASE-05～08、C-LP-01～28、C-RND-01～32=MATCH | 报告 xCap、目标比例和有效边界，不展示全部连续比例。 本轮C验证：证据类型与逐字段值见 c-layer/experiment-tables.md。 | 存在差异 |
...
| M08-F05 | M08 经济临界点 | 两方案成本切换点 | `test_economics=INTERNAL_ONLY`；本轮C验证：C-ENV-07=DIFFERENCE；C-ENV-01～06、C-ENV-08=MATCH | 使用未舍入成本和临界值。 本轮C验证：证据类型与逐字段值见 c-layer/experiment-tables.md。 | 存在差异 |
| M08-F06 | M08 经济临界点 | 全局下包络和支配交点剔除 | `test_case_comparison=INTERNAL_ONLY`；`test_economics=INTERNAL_ONLY`；本轮C验证：C-ENV-07=DIFFERENCE；C-ENV-01～06、C-ENV-08=MATCH | 只保留有效方案切换。 本轮C验证：证据类型与逐字段值见 c-layer/experiment-tables.md。 | 存在差异 |
...
| M09-F05 | M09 多候选比较 | 跨候选成本、达标和改善排名 | `test_case_comparison=INTERNAL_ONLY`；本轮C验证：C-CASE-01、C-CASE-03=DIFFERENCE；C-CASE-02、C-CASE-04～08=MATCH | 排名使用未舍入原始值。 本轮C验证：证据类型与逐字段值见 c-layer/experiment-tables.md。 | 存在差异 |
| M09-F06 | M09 多候选比较 | 达标方案最低成本选择 | `test_case_comparison=INTERNAL_ONLY`；本轮C验证：C-BUILTIN-01、C-CASE-01、C-CASE-03～04、C-CASE-06、C-LP-13、C-LP-17、C-RND-01、C-RND-04、C-RND-10、C-RND-17、C-RND-29=DIFFERENCE；C-CASE-02、C-CASE-05、C-CASE-07～08、C-LP-02～12、C-LP-14～16、C-LP-18、C-LP-21～22、C-LP-27～28、C-RND-02～03、C-RND-05～09、C-RND-11～12、C-RND-14～16、C-RND-20～21、C-RND-23～28、C-RND-30～32=MATCH；C-LP-01、C-LP-19～20、C-LP-23～26、C-RND-13、C-RND-18～19、C-RND-22=MATCH_WITH_ROUNDING | 仅在目标可达且价格完整时给出。 本轮C验证：证据类型与逐字段值见 c-layer/experiment-tables.md。；浮点极近边界以精确参考复核 | 存在差异 |
...
| M11-F04 | M11 相对 B0 与建议 | 达标方案最低成本比例 | `test_case_comparison=INTERNAL_ONLY`；`test_constraints=INTERNAL_ONLY`；本轮C验证：C-BUILTIN-01、C-CASE-01、C-CASE-03～04、C-CASE-06、C-LP-13、C-LP-17、C-RND-01、C-RND-04、C-RND-10、C-RND-17、C-RND-29=DIFFERENCE；C-CASE-02、C-CASE-05、C-CASE-07～08、C-LP-02～12、C-LP-14～16、C-LP-18、C-LP-21～22、C-LP-27～28、C-RND-02～03、C-RND-05～09、C-RND-11～12、C-RND-14～16、C-RND-20～21、C-RND-23～28、C-RND-30～32=MATCH；C-LP-01、C-LP-19～20、C-LP-23～26、C-RND-13、C-RND-18～19、C-RND-22=MATCH_WITH_ROUNDING | 目标不可达或价格缺失时保留对应原因。 本轮C验证：证据类型与逐字段值见 c-layer/experiment-tables.md。；浮点极近边界以精确参考复核 | 存在差异 |
...
| M11-F06 | M11 相对 B0 与建议 | 条件式建议 | `test_case_comparison=INTERNAL_ONLY`；本轮C验证：C-BUILTIN-01、C-CASE-01、C-CASE-04=DIFFERENCE；C-CASE-02～03、C-CASE-05～08=MATCH | 建议包含条件、假设和执行状态。 本轮C验证：证据类型与逐字段值见 c-layer/experiment-tables.md。 | 存在差异 |
